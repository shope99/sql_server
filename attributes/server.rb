...
default['sql_server']['agt_svc_startup_type'] 		= 'Disabled'
default['sql_server']['agt_svc_account'] 					= 'NT AUTHORITY\NETWORK SERVICE'
...
default['sql_server']['rsinstallmodel']					  = 'FilesOnlyMode'
